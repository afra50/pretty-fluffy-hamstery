      ...
      <section className="cta-modern-minimal">
        ...
        <div className="cta-container">
          <div className="cta-content">
            <span className="cta-top-text">Nowy dom, nowa przyjaźń</span>
            <h2 className="cta-heading">
              Twoja wspólna historia może zacząć się już dziś
            </h2>
            <p>
              Wszystkie nasze maluchy opuszczają hodowlę z pełnym rodowodem,
              zdrowe i przygotowane do życia w nowym domu. Sprawdź, kto
              aktualnie czeka na swojego opiekuna.
            </p>
            <div className="cta-actions">
              {/* Zmieniamy wariant na secondary, żeby odbijał od różowego nagłówka */}
              <Button to="/mioty" variant="secondary" className="cta-btn-large">
